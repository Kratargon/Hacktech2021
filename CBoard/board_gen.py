...
def gen_board(board: Board, wdupgrades, whupgrades, wkupgrades, bdupgrades, bhupgrades, bkupgrades):
    ...
    gen_pawns(board, True if "queen" in wkupgrades else False,
              True if "queen" in bkupgrades else False)
    ...
    gen_queens(board, True if "queen" in wkupgrades else False,
               True if "queen" in bkupgrades else False)
    kings = gen_kings(board, True if "king" in wkupgrades else False,
                      True if "king" in bkupgrades else False)
    return kings
